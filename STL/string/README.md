...
| [transform(b, e, b, ::toupper);</br>transform(b, e, b, ::tolower);](https://github.com/ERIN56/Cpp-Team-Notes/blob/master/STL/string/transfrom) | 구간 \[b,e) 안의 원소를 대문자로/소문자로 변경한다. |
