...
* [set에 사용자 정의 객체를 삽입할 때 (const 객체를 사용해야 한다.)](https://github.com/ERIN56/Cpp-Team-Notes/blob/master/PS/set%EC%97%90%20%EC%82%AC%EC%9A%A9%EC%9E%90%20%EC%A0%95%EC%9D%98%20%EA%B0%9D%EC%B2%B4.cpp)
